package lin.house.inventory.wheelview;
 ...
 */  
public class NumericWheelView extends View {  
    /** Scrolling duration */  
...
//    private static final int VALUE_TEXT_COLOR = 0xF0000000; 		//ranni-high light current item
    private static final int VALUE_TEXT_COLOR = 0xF0AA0000;  
    ...
    /** Text size */
//    private static final int TEXT_SIZE = 24; 						//ranni-text larger
...
//    private static final int DEF_VISIBLE_ITEMS = 5; 				//ranni-fulfill InventoryM
    private static final int DEF_VISIBLE_ITEMS = 3;
  
    // Wheel Values  
//    private WheelAdapter adapter = null;							//ranni-must have item..
...
//    	topShadow.setBounds(0, 0, getWidth(), getHeight() / visibleItems);  	//ranni-make shadows smaller
        topShadow.setBounds(0, 0, getWidth(), getHeight() / (visibleItems*2));  	
        topShadow.draw(canvas);  
  
//        bottomShadow.setBounds(0, getHeight() - getHeight() / visibleItems,  getWidth(), getHeight());	//ranni-make shadows smaller
        bottomShadow.setBounds(0, getHeight() - getHeight() / (visibleItems*2),  getWidth(), getHeight());  
    ...
    void finishScrolling() {  
    	System.out.println("finishScroll=" +currentItem);	//ranni
    	Intent intentWheelScrollFinish = new Intent(BroadCastUtil.NUMERIC_WHEEL_SCROLL_INTENT_FILTER);
    	intentWheelScrollFinish.putExtra(BroadCastUtil.NUMERIC_WHEEL_SCROLL_CNT, currentItem);
    	getContext().sendBroadcast(intentWheelScrollFinish);
